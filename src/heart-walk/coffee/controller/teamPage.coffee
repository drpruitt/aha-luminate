angular.module 'ahaLuminateControllers'
  .controller 'TeamPageCtrl', [
    ...
    ($scope, $location, TeamraiserParticipantService) ->
      ...
      TeamraiserParticipantService.getParticipants 'first_name=' + encodeURIComponent('%%%') + '&list_filter_column=reg.team_id&list_filter_text=' + $scope.teamId + '&list_sort_column=total&list_ascending=false&list_page_size=7', 
      error: () ->
