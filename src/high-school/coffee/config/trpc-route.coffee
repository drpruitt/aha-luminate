  ...
  angular.module 'trPcApp'
    .config [
      ...
      ($routeProvider, APP_INFO) ->
        $routeProvider
          .when '/load-error', 
            templateUrl: APP_INFO.rootPath + 'dist/high-school/html/participant-center/view/loadError.html'
            controller: 'NgPcLoadErrorViewCtrl'
          .when '/dashboard', 
            templateUrl: APP_INFO.rootPath + 'dist/high-school/html/participant-center/view/dashboard.html'
          ...
          .when '/email/compose/:messageType?/:messageId?', 
            templateUrl: APP_INFO.rootPath + 'dist/high-school/html/participant-center/view/emailCompose.html'
          ...
          .when '/email/message/:messageType/list', 
            templateUrl: APP_INFO.rootPath + 'dist/high-school/html/participant-center/view/emailMessageList.html'
          ...
          .when '/email/contacts/:filter/list', 
            templateUrl: APP_INFO.rootPath + 'dist/high-school/html/participant-center/view/emailContactsList.html'
            controller: 'NgPcEmailContactsListViewCtrl'
          .when '/reports', 
            templateUrl: APP_INFO.rootPath + 'dist/high-school/html/participant-center/view/reports.html'
            controller: 'NgPcReportsViewCtrl'
          .when '/student-resources', 
            templateUrl: APP_INFO.rootPath + 'dist/high-school/html/participant-center/view/studentResources.html'
            controller: 'NgPcStudentResourcesViewCtrl'
          .when '/teacher-resources', 
            templateUrl: APP_INFO.rootPath + 'dist/high-school/html/participant-center/view/teacherResources.html'
            controller: 'NgPcTeacherResourcesViewCtrl'
          .when '/social', 
            templateUrl: APP_INFO.rootPath + 'dist/high-school/html/participant-center/view/social.html'
          ...
          showLoginModal = ->
            if not $rootScope.loginModal
              $rootScope.loginModal = $uibModal.open 
                scope: $rootScope
                backdrop: 'static'
                templateUrl: APP_INFO.rootPath + 'dist/high-school/html/participant-center/modal/login.html'
