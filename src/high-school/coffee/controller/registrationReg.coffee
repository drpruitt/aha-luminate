      ...
      $scope.$watch 'participationType.id', (newValue) ->
        if newValue
          ...
          setRegistrationQuestionSurveyKey = (questionName, surveyKey) ->
            ...
            if surveyKey is 'ym_high_school_email_type' or surveyKey is 'ym_high_school_grade' or surveyKey is 'ym_high_school_school' or surveyKey is 'ym_high_school_teacher_name' or surveyKey is 'ym_high_school_school_city' or surveyKey is 'ym_high_school_school_state'
              initCustomQuestions()
              $scope.registrationCustomQuestions[surveyKey] = questionName
            else if questionLegend isnt 'Event Date' and surveyKey isnt 'ym_high_school_challenge_info' and surveyKey isnt 'ym_high_school_ecards_sent' and surveyKey isnt 'ym_high_school_ecards_shared' and surveyKey isnt 'ym_high_school_ecards_open' and surveyKey isnt 'ym_high_school_ecards_clicked'
