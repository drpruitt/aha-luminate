      ...
      $scope.$watch 'participationType.id', (newValue) ->
        if newValue
          ...
          setRegistrationQuestionSurveyKey = (questionName, surveyKey) ->
            ...
            if surveyKey is 'ym_high_school_email_type' or surveyKey is 'ym_high_school_grade' or surveyKey is 'ym_high_school_school' or surveyKey is 'ym_high_school_teacher_name' or surveyKey is 'ym_high_school_school_address'
              initCustomQuestions()
