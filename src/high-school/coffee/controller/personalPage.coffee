angular.module 'ahaLuminateControllers'
  .controller 'PersonalPageCtrl', [
    ...
    ($scope, $rootScope, $location, $filter, $timeout, $uibModal, APP_INFO, TeamraiserParticipantService, TeamraiserCompanyService, ParticipantBadgesService, TeamraiserParticipantPageService) ->
      ...
      $scope.personalPagePhoto1 =
        defaultUrl: APP_INFO.rootPath + 'dist/high-school/image/personal-default.jpg'
      
      $scope.editPersonalPhoto1 = ->
        delete $scope.updatePersonalPhoto1Error
        $scope.editPersonalPhoto1Modal = $uibModal.open
          scope: $scope
          templateUrl: APP_INFO.rootPath + 'dist/high-school/html/modal/editPersonalPhoto1.html'
