  ...
  .controller 'NgPcEmailContactsListViewCtrl', [
    ...
    ($rootScope, $scope, $window, $routeParams, $location, $httpParamSerializer, $timeout, $uibModal, APP_INFO, NgPcTeamraiserEmailService, NgPcContactService) ->
      ...
      filterNames = 
        ...
        email_rpt_show_company_coordinator_captains: 'School Team Captains'
      ...
      $scope.addContact = ->
        ...
        $scope.addContactModal = $uibModal.open 
          scope: $scope
          templateUrl: APP_INFO.rootPath + 'dist/high-school/html/participant-center/modal/addContact.html'
      ...
      $scope.importContacts = ->
        ...
        $scope.importContactsModal = $uibModal.open 
          scope: $scope
          templateUrl: APP_INFO.rootPath + 'dist/high-school/html/participant-center/modal/importContacts.html'
      ...
      $scope.chooseImportContactType = ->
        ...
        if not importType or importType is ''
          ...
          if importType is 'csv'
            ...
            $window.open APP_INFO.rootPath + 'dist/high-school/html/participant-center/popup/address-book-import.html?import_source=' + $scope.contactImport.import_type, 'startimport', 'location=no,menubar=no,toolbar=no,height=400'
            false
      ...
      $scope.selectContact = (contact) ->
        ...
        $scope.editContactModal = $uibModal.open
          scope: $scope
          templateUrl: APP_INFO.rootPath + 'dist/high-school/html/participant-center/modal/editContact.html'
      ...
      $scope.deleteContact = (contactId) ->
        ...
        $scope.deleteContactModal = $uibModal.open 
          scope: $scope
          templateUrl: APP_INFO.rootPath + 'dist/high-school/html/participant-center/modal/deleteContact.html'
